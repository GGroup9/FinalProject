...
```
Based on the result, there are 68 observations have leverages higher than 0.02545455 and should be looked at closer as they have the potneital to be influential. However, many observation even though larger than 0.02545455 but still very close to 0.02545455. Typically a point which has high leverage paired with a large residual it is likely to be influential. None of the observation had larger residuals, so we need to dig a little more.
...
```
We see that for our data and model we don't get any Di larger than 1. Thus, no observations are considered to be potential outliers.
