...
popu <- lm( Life.expectancy ~ Population , data = who )
summary(popu)

#Life.expectancy and thinness..1.19.years
thin19 <- lm( Life.expectancy ~ thinness..1.19.years , data = who )
summary(thin19)

#Life.expectancy and thinness.5.9.years
thin59 <- lm( Life.expectancy ~ thinness.5.9.years , data = who )
summary(thin59)
